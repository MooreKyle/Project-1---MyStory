...
let HARDCODED_MOVIES = [Movie(title: "Black Adam",
                        ...
                        Movie(title: "Annie",
                              ...
                              voteCount: 165,
                              popularity: 34.8),
                        Movie(title: "Batman Beyond: Return of the Joker",
                              description: "The Joker is back with a vengeance, and Gotham's newest Dark Knight, Terry McGinnis, needs answers as he stands alone to face Gotham's most infamous Clown Prince of Crime.",
                        ...
                        Movie(title: "Creepshow",
                              description: "Inspired by the E.C. comics of the 1950s, George A. Romero and Stephen King bring five tales of terror to the screen.",
                              posterPath: "/4SoyTCEpsgLjX6yAyMsx3AsAyRQ.jpg",
                              backdropPath: "/8aqTmCHLkktH7RZNALeaOMneHSl.jpg",
                              voteAverage: 7.5,
                              voteCount: 165,
                              popularity: 34.8),
                        Movie(title: "Astro Boy",
